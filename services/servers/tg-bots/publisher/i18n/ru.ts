...
Когда бот присылает уведомление о новом найденном меме, вы можете привязать бота к каналу, чтобы постить в ваш канал прямо из бота по кнопке.
`,
    memeSearch: {
...
Все настройки подписок для канала будут сброшены.`,
    ...
    paymentSuccessful: (date: string) => `🎉 Оплата успешно произведена. Премиум активирован до ${date}!`,
